	...
	$.fn.extend({ 
		...
		var options = $.extend(defaults, options);
    		...
    		return this.each(function() {
				...
				html = '<div id="btn_rt'+randID+'" style="position:absolute; left:33px; bottom:10px;"><a href="javascript:void(0);"><img style="border:none;" src="images/btn_banner_next.png" alt="next" /></a></div>';
				html += '<div id="btn_lt'+randID+'" style="position:absolute; left:10px; bottom:10px;"><a href="javascript:void(0);"><img style="border:none;" src="images/btn_banner_prev.png" alt="prev"/></a></div>';
				$(obj).append(html);
			
				// Pause/play button(img)	
				html = '<a href="javascript:void(0);"><img id="pause_btn'+randID+'" src="images/btn_banner_pause.png" style="position:absolute; left:56px; bottom:17px" alt="Pause" /></a>';
				html += '<a href="javascript:void(0);"><img id="play_btn'+randID+'" src="images/btn_banner_play.png" style="position:absolute; left:56px; bottom:17px; display:none;" alt="Play" /></a>';
				$(obj).append(html);
