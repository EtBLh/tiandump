...
$dm1_sql = "select * from `products` ".$where_sql." order by `seq` asc, `productid` asc";
require "fun/dm1.php";
$list_str = "";
for($i=0;$i<$dm1_count;$i++)
{
	...
	$list_str .= '
	  ...
	  <div class="idx-products-img"><a href="products-detail.php?pd='.$productid.'"><img src="upload/products/productt_pic/'.$productt_pic.'" width="193" height="106" /></a></div>
