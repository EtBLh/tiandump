...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：管理者 </div>
...
for ($i=0; $i<$dm1_count; $i++){
	...
	echo "<tr>\n";
		...
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$title</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$login_date</a></td>\n";
	echo "</tr>\n";
}
?>
</table>
