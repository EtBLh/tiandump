...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：聯絡我們 </div>
...
for ($i=0; $i<$dm1_count; $i++){
	...
	echo "<tr>\n";
		...
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$sex</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$tel</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$email</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$subject</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$send_date</a></td>\n";
	echo "</tr>\n";
}
?>
</table>
