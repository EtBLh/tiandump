...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：首頁廣告 </div>
...
for ($i=0; $i<$dm1_count; $i++){
	...
	$ad_pic = "<img src=\"../upload/$tb/ad_pic/$ad_pic\" />";
	if($ad_url_type == 0){
		$ad_url_type = "原窗体";
	}elseif($ad_url_type == 1){
		$ad_url_type = "新窗体";
	}
	...
	echo "<tr>\n";
		...
		echo "<td><div class=\"photos_css\"><a href=\"javascript:edit_click($id)\" target=\"_self\">$ad_pic</a></div></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$ad_url</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$ad_url_type</a></td>\n";
	echo "</tr>\n";
}
?>
</table>
