...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：聯絡我們 > <?php echo ($mode=='edit')? "修改" : "新增";?> </div>
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
	...
	<tr>
		<td align="right" width="12%">意見主題</td>
	...
	<tr>
		...
		<td><input name="send_date" value="<?=$send_date?>" class="date-pick" /></td>
	</tr>
