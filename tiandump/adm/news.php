...
<tr class="gray">
	<td width="25%" align="right">標題</td><td><input name="news_title" value="<?=$news_title?>"/></td>
</tr>
<tr>
...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：最新消息 </div>
...
if (isset($search_flag) && $search_flag=="search_go" ) {
	if (isset($news_title) && $news_title !="" ) {
		$where_sql .= " and `news_title`='$news_title'";
	}
}
...
for ($i=0; $i<$dm1_count; $i++){
	...
	echo "<tr>\n";
		...
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$news_title</a></td>\n";
		echo "<td><a href=\"javascript:edit_click($id)\" target=\"_self\">$news_date</a></td>\n";
	echo "</tr>\n";
}
?>
</table>
