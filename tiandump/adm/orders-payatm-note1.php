...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：匯款通知 > <?php echo ($mode=='edit')? "修改" : "新增";?> </div>
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
	<tr class="gray">
		<td align="right" width="12%">訂單編號</td>
		<td><input name="ordersno" value="<?=$ordersno?>" /></td>
	</tr>
	<tr>
		<td align="right" width="12%">會員姓名</td>
	...
	<tr>
		<td align="right" width="12%">訂單金額</td>
		<td><input name="order_total" value="<?=$order_total?>" /></td>
	</tr>
	<tr class="gray">
		<td align="right" width="12%">匯出銀行代碼</td>
		<td><input name="bank_no" value="<?=$bank_no?>" /></td>
	</tr>
	<tr>
		<td align="right" width="12%">匯出銀行後五碼</td>
		<td><input name="bank_order_no" value="<?=$bank_order_no?>" /></td>
	</tr>
	<tr class="gray">
	...
	<tr>
		<td align="right" width="12%">備註</td>
		<td><textarea name="message" style="overflow:auto;border-width:1px;" rows="7" cols="80"><?=$message?></textarea></td>
	</tr>
	<tr class="gray">
		<td align="right" width="12%">提交日期</td>
		<td><input name="order_note_date" value="<?=$order_note_date?>" class="date-pick" /></td>
	</tr>
