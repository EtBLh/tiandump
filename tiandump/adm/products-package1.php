...
<div class="box_head_center"><img src="images/nofollow.gif" />當前位置：產品包裝 > <?php echo ($mode=='edit')? "修改" : "新增";?> </div>
...
<table width="100%" align="center" border="0" cellspacing="0" cellpadding="4">
	<tr class="gray">
		<td align="right" width="12%">名称</td>
		<td><input name="package_title" value="<?=$package_title?>" /></td>
	</tr>
